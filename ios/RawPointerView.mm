...
{
    const auto &oldViewProps = *std::static_pointer_cast<RawPointerViewProps const>(_props);
    const auto &newViewProps = *std::static_pointer_cast<RawPointerViewProps const>(props);
